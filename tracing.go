...
type Tracing interface {
	...
	GrpcServerInterceptors() ([]grpc.UnaryServerInterceptor, []grpc.StreamServerInterceptor)
	GrpcClientInterceptors() ([]grpc.UnaryClientInterceptor, []grpc.StreamClientInterceptor)
...
func (n Noop) GrpcServerInterceptors() ([]grpc.UnaryServerInterceptor, []grpc.StreamServerInterceptor) {
	return nil, nil
}

func (n Noop) GrpcClientInterceptors() ([]grpc.UnaryClientInterceptor, []grpc.StreamClientInterceptor) {
	return nil, nil
}
